  ...
  return (
    <Grid container direction="column">
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={mockup} alt="basic website design outline" width="100%" style={{ maxWidth: 500 }} />
        </Grid>
      </Grid>
      {/* Review 1 */}
      <Grid
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={design} alt="painbrush leaving stroke of paint" width="100%" style={{ maxWidth: 500 }} />
        </Grid>
      </Grid>
      {/* Review 2 */}
      <Grid
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={build} alt="building construction site" width="100%" style={{ maxWidth: matchesMD ? 500 : 1000 }} />
        </Grid>
      </Grid>
      {/* Launch */}
      <Grid
      ...
      >
        ...
        <Grid item lg style={{ alignSelf: "center" }}>
          <img src={launch} alt="rocket" width="100%" style={{ maxWidth: 200, maxHeight: 500 }} />
        </Grid>
      </Grid>
      {/* Maintain */}
      <Grid
