...
const Estimate = () => {
  ...
  const getTotal = () => {
    ...
    if (questions.length > 2) {
      const userCost = questions
        .filter((questions) => questions.title === "How many users do you expect?")
  ...
  const websiteSelection = (
    <Grid container direction="column">
      <Grid item container alignItems="center" style={{ marginTop: "14em" }}>
        <Grid item xs={2}>
          <img src={check} alt="checkmark" />
        </Grid>
        <Grid item xs={10}>
              ...
              <Grid item container>
                {question.options.map((option) => (
                  ...
                  >
                    ...
                    <Grid item>
                      <img src={option.icon} alt={option.subtitle} className={classes.icon} />
                    </Grid>
                  </Grid>
                ))}
              </Grid>
            ...
            <Grid item container direction="column" md={7} style={{ maxWidth: "20em" }}>
              ...
              <Grid item>
                ...
                <Typography variant="body1" align={matchesSM ? "center" : undefined} paragraph>
                  Fill out your name, phone number, and email, place your request, and we'll get back to you with
