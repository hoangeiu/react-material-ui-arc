...
const About = (props) => {
  ...
  return (
    <Grid container direction="column">
      ...
      <Grid item container justify="center" className={classes.rowContainer} style={{ marginTop: "5em" }}>
        ...
        <Grid item>
          <Grid item container direction="column" lg style={{ maxWidth: "35em" }}>
            ...
            <Grid item>
              ...
              <Typography align={matchesMD ? "center" : undefined} variant="body1" paragraph>
                It all started with one question: Why aren’t all businesses using available technology? <br />
                There are many different answers to that question: economic barriers, social barriers, educational
      ...
      >
        ...
        <Grid item>
          ...
          <Typography variant="body1" paragraph align="center">
            I startd coding when I was 12 years old.
          </Typography>
        </Grid>
        <Grid item>
        ...
        <Grid item container justify={matchesMD ? "center" : undefined}>
          <Hidden lgUp>
            <Grid item lg style={{ maxWidth: "45em", padding: "1.25em" }}>
              <Typography varient="body1" align="center" paragraph>
          ...
          >
            ...
            <Grid item>
              <Typography variant="caption">a page from Sophomore yearbook</Typography>
            </Grid>
          </Grid>
          <Hidden mdDown>
            <Grid item lg style={{ maxWidth: "45em", padding: "1.25em" }}>
          ...
          <Grid item container alignItems={matchesMD ? "center" : "flex-end"} direction="column" lg>
            <Grid item>
