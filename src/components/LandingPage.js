...
import { Grid, Typography, Button, useMediaQuery, Card, CardContent } from "@material-ui/core";
          ...
          <Card className={classes.revolutionCard}>
            <CardContent>
              <Grid container direction="column" style={{ textAlign: "center" }}>
                ...
                <Grid item>
                  <Typography variant="subtitle1">
                    Visionary insights coupled with cutting-edge technology is a recipe for the revolution.
                  </Typography>
                  <Button
                    component={Link}
                    to="/revolution"
